    ...
    <div className="jr-page-row">
      <div className="jr-stacked">
        <div className="jr-stacked-bottom jr-root">
          {hasTrades ? (
            <JournalTab positions={positions} livePositions={state.sync.positions} trades={state.sync.trades} entries={entries} updateEntry={updateEntry} setups={setups} addSetup={addSetup} cashBalance={state.sync.cashBalance} cashByCurrency={state.sync.cashByCurrency} />
          ) : (
            <>
